...
#include "sym_trap_functionCustomVariables.h"
    ...
    double costFunctionIoU();
    double costFunctionCorr();
    ...
    bool initializeIoU(std::string &error_message);
    bool initializeCorr(std::string &error_message);
    ...
    bool destructIoU(std::string &error_message);
    bool destructCorr(std::string &error_message);
