...
class MainScreen : public QMainWindow {
   ...
   private:
    ...
    double UF_BLUE[3] = {220, 20, 60};
    double UF_ORANGE[3] = {255, 215, 0};
    ...
    // Update all camera
    void update_background_camera_config(Calibration my_cal, bool use_cam_A);
    void update_scene_camera_config(Calibration my_cal, bool use_cam_A);
