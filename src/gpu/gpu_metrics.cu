...
namespace gpu_cost_function {
	...
	GPUMetrics::GPUMetrics() {
		...
		////////////////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////
		/*Initialize Pinned Memory for Corr Intermediary */
		cudaHostAlloc((void**)&corr_score_, sizeof(float), cudaHostAllocDefault);
		if (cudaGetLastError() != cudaSuccess)
			initialized_correctly_ = false;

		/*Initialize Pinned Memory for Corr Intermediary */
		cudaHostAlloc((void**)&corr_norm_, sizeof(float), cudaHostAllocDefault);
		if (cudaGetLastError() != cudaSuccess)
			initialized_correctly_ = false;
			
		/*Allocate GPU buffers for Corr Intermediary*/
		cudaMalloc((void**)&dev_corr_score_, sizeof(float));
		if (cudaGetLastError() != cudaSuccess)
			initialized_correctly_ = false;

		/*Allocate GPU buffers for Corr Intermediary*/
		cudaMalloc((void**)&dev_corr_norm_, sizeof(float));
		if (cudaGetLastError() != cudaSuccess)
			initialized_correctly_ = false;
		////////////////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////
