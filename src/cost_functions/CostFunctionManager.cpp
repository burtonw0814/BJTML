...
double CostFunctionManager::callActiveCostFunction() {
    ...
    } else if (active_cost_function_ == "IoU") {
        return costFunctionIoU();
    } else if (active_cost_function_ == "MASKED_CORRELATION") {
        return costFunctionCorr();
    } else {
        return costFunctionDIRECT_DILATION();
    }
};
...
bool CostFunctionManager::InitializeActiveCostFunction(
    ...
    if (active_cost_function_ == "DIRECT_DILATION") {
        ...
        return initializeIoU(error_message);
    } else if (active_cost_function_ == "MASKED_CORRELATION") {
        return initializeCorr(error_message);
    } else {
        error_message =
...
bool CostFunctionManager::DestructActiveCostFunction(
    ...
    if (active_cost_function_ == "DIRECT_DILATION") {
        ...
        return destructIoU(error_message);
    } else if (active_cost_function_ == "MASKED_CORRELATION") {
        return destructCorr(error_message);
    }else {
        error_message =
            "Could not find active cost function: " + active_cost_function_;
        return false;
...
void CostFunctionManager::listCostFunctions() {
    ...
    /*Begin Cost Function Listing*/
    /*Cost Function Name: IoU*/
    /*Parameters: */
    CostFunction instance_iou = CostFunction("IoU");
    //instance_iou.addParameter(
    //    Parameter<bool>("Black_Silhouette", true));
    available_cost_functions_.push_back(instance_iou);
    /*End Cost Function Listing*/
    
    /*Begin Cost Function Listing*/
    /*Cost Function Name: IoU*/
    /*Parameters: */
    CostFunction instance_corr = CostFunction("MASKED_CORRELATION");
    //instance_iou.addParameter(
    //    Parameter<bool>("Black_Silhouette", true));
    available_cost_functions_.push_back(instance_corr);
    /*End Cost Function Listing*/
